...
// The same app as `apps/playgrounds/svelte`, on Svelte 5 — and its whole reason for
...
// Svelte 4 playground. "Works on Svelte 4 and 5" needs a Svelte 5 build to say so.
//
