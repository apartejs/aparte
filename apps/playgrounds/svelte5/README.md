...
on Svelte 4, and so did the only playground.

Run it like any other playground, or let the browser suite do it:

```bash
pnpm --filter @aparte-workspace/playground-svelte5 dev
