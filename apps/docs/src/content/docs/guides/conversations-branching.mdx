...
The picker below is the real bubble, rendered from the element's own example — the
control this page is about, before any of the code that produces it.

<ElementPreview tag="aparte-chat-bubble" />
