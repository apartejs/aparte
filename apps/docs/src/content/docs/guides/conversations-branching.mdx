---
title: Edit, regenerate and branch a chat conversation
...
<Demo id="branch-picker" caption="One reply among two. The picker appears on its own as soon as a message has siblings." />
